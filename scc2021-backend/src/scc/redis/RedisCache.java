...
public class RedisCache {
	...
	private static final String RedisHostname = "scc50415-cache.redis.cache.windows.net";
	private static final String RedisKey = "GA5s+AsN5TIMkkkc8KuJoYWwDRWzXuECwqzFzCRhKy8=";
